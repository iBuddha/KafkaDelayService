 ...
 */
@nonthreadsafe
private[delay] class TimingWheel(tickMs: Long, wheelSize: Int, startMs: Long, taskCounter: AtomicLong, delayQueue: DelayQueue[TimerBucket]) {

  private[this] val interval = tickMs * wheelSize
  private[this] val buckets = Array.tabulate[TimerBucket](wheelSize) { _ => new VectorBasedTimerBucket(taskCounter)}
...
//object TimingWheel {
//  val logger = LoggerFactory.getLogger(TimingWheel.getClass)
//}
